  ...
  return (
    ...
    <section className="footer">
        <div className="box-container">
          <div className="box">
            <h3>Address</h3>
            <a href="googlemaplink">Tollygunge, Kolkata</a>
        ...
        <div className="box">
            <h3>Contact Us </h3>
                ...
                <i className="fa">
                <a href="tel:+91 8888817886">+91 7003858618 </a></i>  
                <br></br>
                <i className="fa">
                <a href="mailto:info.shubham@gmail.com">arnabmajumdar399@gmail.com</a></i>
            </div>
        <div className="box">
            <h3>Follow us</h3>
            <link
    ...
    <div className="credits">
        <p>© 2024 Arnab. All Rights Reserved by GymFluencer.</p>
      </div>
    </div>
    </>
  );
